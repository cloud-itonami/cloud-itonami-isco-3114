(ns elex.actor
  "ElexActor — the ISCO-08 3114 electronics engineering technician field
  ...
  a record or dispatch a robot action the ElexGovernor refuses — every
...
(defn build-graph
  "Build a compiled ElexActor graph. `store` implements
  `elex.store/Store`. `advisor` implements `elex.advisor/Advisor`
